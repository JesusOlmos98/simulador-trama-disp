...
import { crearDefaultDispositivoTablaOld, defaultEstadisticoValorOld, defaultPresentacionOmegaOld, defaultTablaPrefabricada } from "src/utils/dtoBE/defaultTramaOld";
...
import { PresentacionCentralOldDto, RtTablaCentralFinOldDto, RtTablaCentralMasOldDto, serializarTablaCentralItemsOld, TablaCentralItemOld } from "src/utils/dtoBE/tt_sistemaOld.dto";
import { defaultDataTempSonda1, defaultDataContadorAgua, defaultDataActividadCalefaccion1, defaultDataEventoInicioCrianza, defaultDataAlarmaTempAlta, defaultDataCambioParametro, defaultPresentacionCTI40 } from "src/utils/dtoLE/defaultTrama";
